...
public class MatchRecommendationService {
    ...
    public List<MatchRecommendationDTO> getMatchingRecommendations(Long userId) {
        // 1. 사용자의 userId를 통해 UserEntity 객체를 찾음
        ...
        // 7. 상위 10개 추천 목록만 DB에 저장하기 위한 엔티티 리스트 반환
